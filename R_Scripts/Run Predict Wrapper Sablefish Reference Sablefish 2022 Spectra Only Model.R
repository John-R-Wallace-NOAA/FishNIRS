...
# ---- Standard call to Predict_NN_Age_Wrapper() -----

library(JRWToolBox) 
 
source("C:/SIDT/Predict_NN_Ages/Predict_NN_Age_Wrapper.R")
 
assign("Spectra_Set", "Sable_Combo_2022", pos = 1)
 
Predict_NN_Age_Wrapper(Spectra_Set = Spectra_Set, Train_Result_Path = "C:/SIDT/Sable_Combo_2022/NN_Fish_No_Len_Nor_Otie_Wgt_SCANS_ONLY",  Multi_Year = FALSE, 
      Model_Spectra_Meta_Path = "C:/SIDT/Sable_Combo_2022/Sable_Combo_2022_Model_Spectra_Meta_ALL_GOOD_DATA.RData", Use_Session_Report_Meta = TRUE)
	


# --------------------------------	Check Reference scan using Sablefish 2022 spectra only model -----------------------
...
Predict_NN_Age_Wrapper(Spectra_Set = Spectra_Set, Train_Result_Path = "C:/SIDT/Sable_Combo_2022/NN_Fish_No_Len_Nor_Otie_Wgt_SCANS_ONLY",  Multi_Year = FALSE, 
      Model_Spectra_Meta_Path = NULL, Extra_Meta_Path = "No_Default", Use_Session_Report_Meta = TRUE, Meta_Path = paste0('C:/SIDT/Sablefish 2019 Combo/Sable_Combo_2019_NIRS_Scanning_Session_Report_For_NWFSC.xlsx'))
	  
	  
	  
	  
# To debug Predict_NN_Age_Wrapper()
Spectra_Set = Spectra_Set; Train_Result_Path = "C:/SIDT/Sable_Combo_2022/NN_Fish_No_Len_Nor_Otie_Wgt_SCANS_ONLY";  Multi_Year = FALSE
Model_Spectra_Meta_Path = NULL; Use_Session_Report_Meta = TRUE; Meta_Path = 'C:/SIDT/Sablefish 2019 Combo/Sable_Combo_2019_NIRS_Scanning_Session_Report_For_NWFSC.xlsx'
...
Max_N_Spectra = N_Samp; Extra_Meta_Path = "No_Default"; htmlPlotFolder = paste0(Predicted_Ages_Path, '/', Spectra_Set, '_Spectra_Sample_of_', N_Samp)	  
shortNameSegments = c(1, 6); shortNameSuffix = 'COMBO'; yearPosition = 6; fineFreqAdj = 0
Meta_Path = 'C:/SIDT/Sablefish 2019 Combo/Sable_Combo_2019_NIRS_Scanning_Session_Report_For_NWFSC.xlsx'; TMA_Ages = TRUE; excelSheet = 3
...
Meta_Path = 'C:/SIDT/Sablefish 2019 Combo/Sable_Combo_2019_NIRS_Scanning_Session_Report_For_NWFSC.xlsx'	
...
# specimen_id is the same, but the fileName doesn't match the NWFSC_NIR_Filename
