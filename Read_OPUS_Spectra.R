...
# plotly_spectra(Sable_Combo_2022_Scans, N_Samp = 300, htmlPlotFolder = 'Figures/Sablefish_2022_Spectra_Sample_of_300')
 ...
 Read_OPUS_Spectra <- function(Spectra_Set = c("Hake_2019", "Sable_2017_2019", "Sable_Combo_2022")[3], Spectra_Path, verbose = c(TRUE, FALSE)[1], plot = c(TRUE, FALSE)[2],
                         Max_N_Spectra = list(50, 200, 'All')[[3]], spectraInterp = c('stats_splinefun_lowess', 'prospec
