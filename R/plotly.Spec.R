plotly.Spec <- function(spectraMeta, N_Samp = 50, randomAfterSampNum = NULL, colorGroup = 'Age', WaveRange = c(0, 8000), scanUniqueName = 'shortName', 
                  freqNum = NULL, xlab = "Wavenumber", ylab = "Absorbance", plot = TRUE, reverse.plot.order = FALSE, bgcolor = "#e5ecf6", 
