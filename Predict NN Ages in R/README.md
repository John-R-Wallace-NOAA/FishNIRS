...
- Put an R Keras NN model (as a '.Rdata' file) into the 'FCNN Model' directory and change the name in 'NN_Model' relative path (around line 90) to reflect the model's name. ('m3' is short for miniconda3.)
